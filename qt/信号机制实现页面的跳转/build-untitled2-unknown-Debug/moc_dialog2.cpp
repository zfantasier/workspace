...
QT_MOC_LITERAL(4, 24, 29), // "on_previousPushButton_clicked"
QT_MOC_LITERAL(5, 54, 25) // "on_nextPushButton_clicked"

    },
    "Dialog2\0display\0\0number\0"
    "on_previousPushButton_clicked\0"
...
void Dialog2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog2::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog2::display)) {
                *result = 0;
            }
        }
    }
