...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Dialog1_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 24, 21) // "on_pushButton_clicked"
    ...
    "Dialog1\0display\0\0number\0on_pushButton_clicked"
};
...
void Dialog1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog1::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog1::display)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Dialog1::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Dialog1.data,
