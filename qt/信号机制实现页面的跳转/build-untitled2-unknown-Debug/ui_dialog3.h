...
public:
    ...
    void setupUi(QDialog *Dialog3)
    {
        ...
        previousPushButton = new QPushButton(Dialog3);
        previousPushButton->setObjectName(QStringLiteral("previousPushButton"));
        previousPushButton->setGeometry(QRect(150, 180, 99, 27));
    ...
    void retranslateUi(QDialog *Dialog3)
    {
        ...
        previousPushButton->setText(QApplication::translate("Dialog3", "Previous", 0));
    } // retranslateUi
