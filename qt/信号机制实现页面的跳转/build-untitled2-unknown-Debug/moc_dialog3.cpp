...
void Dialog3::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog3::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog3::display)) {
                *result = 0;
            }
        }
    }
